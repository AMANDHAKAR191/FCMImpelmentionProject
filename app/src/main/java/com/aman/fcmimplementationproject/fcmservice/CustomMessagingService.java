package com.aman.fcmimplementationproject.fcmservice;
...
import com.aman.fcmimplementationproject.MainActivity;
import com.aman.fcmimplementationproject.R;
    ...
    private void notifyUser(String title, String messageBody) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.baseline_chat_bubble_outline_24)
...
//        }
    ...
    public void notificationActions(Map<String, String> dataMap) {
        ...
        builder3.setSmallIcon(R.drawable.baseline_chat_bubble_outline_24)
                .setContentTitle(title)
                .setContentText(message)
                .setColor(Color.BLUE)
                .setSound(defaultSoundUri)
    ...
    public void directReply(Map<String, String> dataMap) {
        ...
        builder4.setSmallIcon(R.drawable.baseline_chat_bubble_outline_24)
                .setContentTitle(title)
                .setContentText(message)
                .setAutoCancel(true)
                .setSound(defaultSoundUri)
    ...
    public void messageTypeNotification(Map<String, String> dataMap) {
        ...
        builder6.setSmallIcon(R.drawable.baseline_chat_bubble_outline_24)
                .setColor(Color.RED)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.baseline_chat_bubble_outline_24))
                .setSound(defaultSoundUri)
                .setStyle(style)
                .setAutoCancel(true);
        builder6.build();
